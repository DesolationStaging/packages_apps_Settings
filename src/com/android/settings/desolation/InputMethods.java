...
public class InputMethods extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    private static final String TAG = "InputMethods";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.input_methods);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        InputMethods getOwner() {
            return (InputMethods) getTargetFragment();
        }
